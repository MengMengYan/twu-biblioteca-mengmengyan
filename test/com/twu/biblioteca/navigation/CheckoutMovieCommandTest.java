...
public class CheckoutMovieCommandTest {
    ...
    public void checkoutMovieLibrarianView() {
        ...
        assertEquals("Title2\t|\t2000\t|\tDirector2\t|\tunrated", this.testee.execute(inventory, null));
    }

    @Test
    public void checkoutSuccessfully() {
        assertEquals("Thank you! Enjoy the movie", testee.execute(inventory, "Title1"));
    }

    @Test
    public void checkoutUnsuccessfully() {
        assertEquals("That movie is not available", testee.execute(inventory, "Title3"));
    }
}
